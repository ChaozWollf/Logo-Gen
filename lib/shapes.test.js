...
describe('Circle', () => {
    test('should render svg for a green circle element', () => {
        const expectedSvg = '<circle cx="100" cy="100" r="200" stroke=\"transparent\" fill="green\" stroke-width=\"5\" />';
    ...
    test('should accept fillCollor param', () => {
        const expectedSvg = '<circle cx="100" cy="100" r="200" stroke=\"transparent\" fill="blue\" stroke-width=\"5\" />';
        const circle = new Circle();
