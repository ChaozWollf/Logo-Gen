...
describe('Triangle', () => {
    ...
    test('should accept fillCollor param', () => {
        const expectedSvg = '<polygon points="25, 18 244, 182 56, 182" stroke=\"transparent\" fill="blue\" stroke-width=\"5\" />';
        const triangle = new Triangle();
...
describe('Square', () => {
    test('should render svg for a green square element', () => {
        const expectedSvg = '<rect x="10" y="10" width="30" height="30" stroke=\"transparent\" fill="green"\ stroke-width=\"5\" />'
    ...
    test('should accept fillCollor param', () => {
        const expectedSvg = '<rect x="10" y="10" width="30" height="30" stroke=\"transparent\" fill="blue"\ stroke-width=\"5\" />'
        const square = new Square();
